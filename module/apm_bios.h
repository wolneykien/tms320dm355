...
#define APM_IOC_PLLM_91		_IO('A', 4)
#define APM_IOC_PLLM_179	_IO('A', 8)
#define APM_IOC_USB_OFF		_IO('A',16)
#define APM_IOC_USB_ON		_IO('A',32)
#define APM_IOC_DDRSR_ON	_IO('A',64)
#define APM_IOC_DDRSR_OFF	_IO('A',128)
#define APM_IOC_PLLM_BYPASS	_IO('A',256)
#define APM_IOC_PLLM_PLL	_IO('A',512)
